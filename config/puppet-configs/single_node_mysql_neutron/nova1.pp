...
class { "nova::api":
  ...
  neutron_metadata_proxy_shared_secret => 'foobar',
}
...
nova_config {
  ...
  'DEFAULT/neutron_admin_tenant_name': value => 'service';
  'DEFAULT/neutron_admin_username':    value => 'neutron';
  'DEFAULT/neutron_admin_password':    value => 'SERVICE_PASSWORD', secret => true;
